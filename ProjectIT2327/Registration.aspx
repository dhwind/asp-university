<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="ProjectIT2327.WebForm2" %>
...
<head>
    ...
    <title>Online FoodTaxi | Registration</title>
...
<body>
    ...
    <header class="head">
        ...
        <div class="head-panel">
            ...
            <div class="auth">
                <asp:Button runat="server" ID="LoginBtn" Text="Login" OnClick="log_Onclick" class="auth-btn" />
                <span>/</span>
                <asp:Button runat="server" ID="RegisterBtn" Text="Registration" OnClick="reg_Onclick" class="auth-btn" />
            </div>
            <div class="cart">
    ...
    <main class="main">
        ...
        <div class="container-reg">    
            ...
            <div class="col-md-6">    
                ...
                <asp:Label ID="Exist" class="empty-field" runat="server"></asp:Label>
            <div class="form-group">    
                <label for="email">Name:</label>
                <asp:Label ID="EmName" class="empty-field" runat="server"></asp:Label>
                <asp:TextBox ID="Txtname" class="form-control width-control" placeholder="Enter Name" runat="server"></asp:TextBox>    
            </div>    
              <div class="form-group"> 
            <div class="form-group">    
